...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.websites'
        db.add_column('profile', 'websites', self.gf('django.db.models.fields.TextField')(default='', max_length=600, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserProfile.website'
        db.add_column('profile', 'website', self.gf('django.db.models.fields.URLField')(default='', max_length=200, null=True, blank=True), keep_default=False)

        # Deleting field 'UserProfile.websites'
        db.delete_column('profile', 'websites')
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'websites': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '600', 'null': 'True', 'blank': 'True'})
        }
    }
